    ...
    def __init__(self):
        ...
        self.agent = Agent(
            ...
            system_prompt=(
                ...
                "12. DO NOT use backslashes '\\' for line continuation in the generated code. Python's 'eval' handles newlines inside parentheses automatically.\n"
                "13. 'Exactly N X are Y' (without specifying a total count of X) means `count(X and Y) == N`. Do NOT infer `count(X) == N` unless explicitly stated (e.g. 'Exactly N of the M X...').\n\n"
                "--- Examples ---\n"
